class CfgPatches
{
  class WS_Props_Decals
  {
    ...
    requiredAddons[] = { };
    units[] = {
      "WS_Props_WithMyLittleEye_Decals_Rooms_Airlock",
      "WS_Props_WithMyLittleEye_Decals_Rooms_Armory",
      "WS_Props_WithMyLittleEye_Decals_Rooms_Bridge",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Sensors",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Tactical",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Comms",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Engineering",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Reactor",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Data",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_XO",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_3IC",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Helm",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Navigation",
      "WS_Props_WithMyLittleEye_Decals_BridgeSeats_Captain",
    };
  };
};
