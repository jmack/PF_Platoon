...
/*class DMNS_UNSCMENU_RscProgress
{
...
class DMNS_UNSCMENU_RscControlsGroup
{
	deletable = 0;
	fade = 0;
	h = 1;
...
class DMNS_UNSCMENU_RscStructuredText
{
...
class DMNS_UNSCMENU_RscPicture
{
...
class DMNS_UNSCMENU_RscCheckBox
{
	checked = 0;
	color[] = {1,1,1,0.7};
	colorBackground[] = {0,0,0,0};
...
class DMNS_UNSCMENU_RscListBox
{
...
class DMNS_UNSCMENU_SructuredText
{
...
class DMNS_UNSCMENU_ButtonInvisible
{
...
class DMNS_UNSCMENU_RscListNBox
{
...
class DMNS_UNSCMENU_rscMapControl
{
