...
class CfgWeapons
{
  ...
  class PF_Armor_Vests_Reid_Wizard : PF_Armor_Vests_M52D_Wizard
  {
    class XtdGearInfo
    {
    ...
    hiddenSelectionsTextures[] =
    {
      ...
      "",
      "PF_Armor\reid\vests\M52D\_textures\odst_black.paa",
    };
