...
class CfgWeapons
{
  ...
  class PF_Armor_Vests_Winter_Wizard : PF_Armor_Vests_M52D_Wizard
  {
    class XtdGearInfo
    {
    ...
    hiddenSelectionsTextures[] =
    {
      ...
      "PF_Armor\winter\vests\M52D\_textures\armor_black.paa",
      "PF_Armor\_base\vests\M52D\_textures\wizard\black\legs.paa",
      "",
      "PF_Armor\winter\vests\M52D\_textures\odst_black.paa",
    };
