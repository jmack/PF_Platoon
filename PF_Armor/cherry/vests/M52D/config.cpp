...
class CfgWeapons
{
  ...
  class PF_Armor_Vests_Cherry_Pathfinder : PF_Armor_Vests_M52D_Pathfinder
  {
    class XtdGearInfo
    {
    ...
    hiddenSelectionsTextures[] =
    {
      ...
      "PF_Armor\cherry\vests\M52D\_textures\legs_black.paa",
      "",
      "PF_Armor\cherry\vests\M52D\_textures\odst_black.paa",
    };
